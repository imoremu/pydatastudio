...
class AbstractDataBasicStudent(AbstractStudent):
    ...
    Research methods has to be named with the name of the research substituting any space o special char by underscore '_' and should have as attributes:

            research_name: str, **attrs: Any
    ...
    def _research(self, research_name: str, **attrs: Any) -> pd.DataFrame:
        """
        ...
        :return: The research result as a DataFrame
